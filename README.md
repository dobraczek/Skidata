...
Ukázka výstupu API při otestování například validity čipu: https://webscript.cz/SkidataAPI/ (Funguje v případě, že SKIDATA mají povolenou testovací verzi serveru. Ukázka není napojena na ostrou databázi.)
